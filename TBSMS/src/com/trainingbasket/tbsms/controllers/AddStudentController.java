...
import com.trainingbasket.tbsms.utils.DateUtils;
...
//		System.out.println(preparedStatement.executeLargeUpdate());
	...
	private Student ValidateParams(HttpServletRequest request, HttpServletResponse response, List<String> errMsg) throws ParseException {
		Student student = null;
		String name = request.getParameter("name");
		Date dob = DateUtils.readDate( request.getParameter("DOB"));
