...
<link rel="stylesheet" type="text/css" href="<%=getServletContext().getContextPath() %>/crmlogin/crmloginstyle.css">
</head>
<body bgcolor="#225caf45">
		...
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-info">
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					<form id="loginform" class="form-horizontal" action="AuthController" method="post" role="form">
