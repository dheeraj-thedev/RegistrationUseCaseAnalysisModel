...
<meta name="author" />
<title>Training Basket Admin - Dashboard</title>
...
<body id="page-top">
							...
							<fieldset>
								...
								<div class="form-group">
									<label for="lastname"><span class="req">* </span>
										Father name: </label> <input class="form-control" type="text"
										name="fathername" id="txt" onkeyup="Validate(this)"
										placeholder="hyphen or single quote OK" required />
									<div id="errLast"></div>
								</div>

								<div class="form-group">
									<label for="date"><span class="req">* </span> date of
										birth: </label> <input class="form-control" type="date" name="birthdate"
										id="birthdate" onkeyup="Validate(this)"
										placeholder="hyphen or single quote OK" required />
									<div id="errLast"></div>
								</div>
								...
								<div class="form-group">
									...
									<div class="form-group">
										<label for="Address"><span class="req">* </span>
											Address: </label> <input class="form-control" type="text"
											name="address" id="txt"  required />
										<div id="errFirst"></div>
										
										<!-- this is main code to validate onkeyup="Validate(this)" -->
									</div>
 ...
 -->
									...
									<div class="form-group">
										...
										<label for="password"><span class="req">* </span>
											...
											maxlength="16" placeholder="Enter again to validate"
 ...
 -->									<div class="form-group">
									...
									<div class="form-group">
										<label for="sel1" class="lables">Select City:</label> <select
											class="form-control" id="sel1" name="city" required>
											<option></option>
								...
								<div class="form-group">
									<label for="pincode"><span class="req">* </span>
										Pincode Number: </label> <input required type="text" name="pin"
										id="phone" class="form-control phone" maxlength="8"
										onkeyup="validatephone(this);"
									...
									<%-- 									<div class="form-group">
										...
										<input type="checkbox" required name="terms"
											...
											id="field_terms">   <label for="terms">I
											agree with the <a href="terms.php"
